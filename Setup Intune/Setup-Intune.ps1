...
#
.SYNOPSIS
This script imports baseline compliance and device configuration policies for common platforms.
...

{
    ...
    "description":  "Require 1809 minimum, encryption, firewall, and antivirus",
...

{
    ...
    "displayName":  "iOS MAM policy - PIN and boundaries",
    "description":  "Encryption with passcode and copy/paste/save restrictions",
...
{
    "@odata.context":  "https://graph.microsoft.com/Beta/$metadata#deviceAppManagement/iosManagedAppProtections(apps())/$entity",
    "displayName":  "iOS MAM policy - encrypt only",
    "description":  "Encrypt app data only",
    "periodOfflineBeforeAccessCheck":  "PT12H",
    "periodOnlineBeforeAccessCheck":  "PT0S",
    "allowedInboundDataTransferSources":  "allApps",
    ...
    "apps@odata.context":  "https://graph.microsoft.com/Beta/$metadata#deviceAppManagement/iosManagedAppProtections(\u0027T_de096afe-e9b9-4155-95ea-3af78993f9e2\u0027)/apps",
    "apps":  [
                 {
                     "id":  "com.microsoft.intune.managedbrowser.ios",
                     "version":  "-1480721402",
...

{
    ...
    "displayName":  "Android MAM policy - PIN and boundaries",
    "description":  "Encryption with passcode and copy/paste/save restrictions",
    "periodOfflineBeforeAccessCheck":  "PT12H",
    "periodOnlineBeforeAccessCheck":  "PT0S",
    "allowedInboundDataTransferSources":  "allApps",
...
$MAM_AndroidEncryptOnly = @"

{
    "@odata.context":  "https://graph.microsoft.com/Beta/$metadata#deviceAppManagement/androidManagedAppProtections(apps())/$entity",
    "displayName":  "Android MAM policy - encrypt only",
    "description":  "Encrypt app data only",
    "periodOfflineBeforeAccessCheck":  "PT12H",
    "periodOnlineBeforeAccessCheck":  "PT0S",
    "allowedInboundDataTransferSources":  "allApps",
    ...
    "apps@odata.context":  "https://graph.microsoft.com/Beta/$metadata#deviceAppManagement/androidManagedAppProtections(\u0027T_dbdd38c7-1d44-4dcb-ac63-bd6fe1506ba8\u0027)/apps",
    "apps":  [
                 {
                     "id":  "com.microsoft.emmx.android",
                     "version":  "-725393251",
...

{
  ...
  "displayName": "Windows 10: WIP MDM baseline",
